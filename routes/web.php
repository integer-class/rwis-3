...
Route::group(['prefix' => 'information'], function () {
    ...
    Route::group(['prefix' => 'facility'], function () {
        ...
        Route::get('/show/{id}', [FacilityController::class, 'show'])->name('infromation.facility.show')->middleware('auth.guard');
        Route::get('/edit/{id}', [FacilityController::class, 'edit'])->name('infromation.facility.edit')->middleware('auth.guard');
        Route::put('/{id}', [FacilityController::class, 'update'])->middleware('auth.guard');
        Route::get('facility/{id}/edit', [FacilityController::class, 'edit'])->name('facility.edit')->middleware('auth.guard');
        Route::get('facility/{id}', [FacilityController::class, 'show'])->name('facility.show')->middleware('auth.guard');
    ...
    Route::group(['prefix' => 'umkm'], function () {
        ...
        Route::get('/show/{id}', [UmkmController::class, 'show'])->name('infromation.umkm.show')->middleware('auth.guard');
        Route::get('/edit/{id}', [UmkmController::class, 'edit'])->name('infromation.umkm.edit')->middleware('auth.guard');
        ...
        Route::get('umkm/{id}/edit', [UmkmController::class, 'edit'])->name('umkm.edit')->middleware('auth.guard');
        Route::get('umkm/{id}', [UmkmController::class, 'show'])->name('umkm.show')->middleware('auth.guard');
    });
});
