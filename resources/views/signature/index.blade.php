...
@section('content')
    ...
    <div class="py-12 bg-white shadow-xl rounded-t-lg mt-5 mx-5">
        <div class="max-w-7-xl mx-auto sm:px-6 lg:px-8">
            <h3 class="mb-3 text-3xl">Digital Signature</h3>
            ...
            {{-- content --}}
            <a href="{{ url('signature/document-format') }}">
                <div
                    ...
                    <div class="card-body flex justify-center">
                        <h2 class=" text-3xl font-bold">Format</h2>
