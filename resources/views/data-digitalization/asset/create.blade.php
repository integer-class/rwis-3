...
@section('content')
    ...
    <div class="py-12 bg-white shadow-xl rounded-t-lg mt-5 mx-5">
        <div class="max-w-7-xl mx-auto sm:px-6 lg:px-8">
            ...
            {{-- content --}}
            <form action="{{ url('data/asset') }}" method="POST" class="flex flex-col space-y-4 w-full form mr-3">
                @csrf
                @if ($errors->any())
                ...
                <div class="flex flex-col space-y-1">
                    ...
                    <input type="text" name="name" id="name"
                        class="rounded-md border border-gray-300 p-2" placeholder="Enter your Asset Name">
                </div>
                <div class="flex">
