            ...
            <div class="border-t border-gray-200">
                <dl>
                    ...
                    <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                        <dt class="text-sm font-medium text-gray-500">Account Credit</dt>
                        <dd class="mt-1 text-sm text-gray-900 sm:col-span-2">{{ $cashMutation->accountCredit->name_account }}</dd>
                    </div>
                    <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                        <dt class="text-sm font-medium text-gray-500">Credit</dt>
                        <dd class="mt-1 text-sm text-gray-900 sm:col-span-2">Rp{{ number_format($cashMutation->credit, 2, ',', '.') }}</dd>
                    </div>
                    <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                        <dt class="text-sm font-medium text-gray-500">Debit</dt>
                        <dd class="mt-1 text-sm text-gray-900 sm:col-span-2">Rp{{ number_format($cashMutation->debit, 2, ',', '.') }}</dd>
                    </div>
                    <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                        <dt class="text-sm font-medium text-gray-500">Account Debit</dt>
                        <dd class="mt-1 text-sm text-gray-900 sm:col-span-2">{{ $cashMutation->accountDebit->name_account }}</dd>
                    </div>
                    <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
