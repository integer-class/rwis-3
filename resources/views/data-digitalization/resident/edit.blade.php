...
@section('content')
    ...
    <div class="py-12 bg-white shadow-xl rounded-t-lg mx-5 mt-5">
        <div class="max-w-7-xl mx-auto sm:px-6 lg:px-8">
            ...
            {{-- content --}}
            <form action="{{ url('/resident/' . $resident->resident_id) }}" method="POST" class="flex flex-col space-y-4 w-full form mr-3">
                @csrf
                {!! method_field('PUT') !!}
                @if ($errors->any())
                ...
                <div class="flex flex-col space-y-1">
                    ...
                    <input type="text" name="full_name" id="full_name" class="rounded-md border border-gray-300 p-2"
                        placeholder="Enter your full name" autofocus value="{{ old('full_name', $resident->full_name) }}">
                </div>
                <div class="flex flex-col space-y-1">
