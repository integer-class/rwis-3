...
<html lang="en" data-theme="light">
    ...
    <body class="flex h-screen items-center justify-center">
        <main>
            <div class="rounded-lg max-w-screen-lg shadow-2xl flex w-full">
                {{-- image --}}
                <div class="w-2/3">
                ...
                <div class="w-1/2 flex flex-col justify-center items-center space-y-5">
                    ...
                    <form action="{{ url('/auth') }}" method="POST" class="flex flex-col space-y-4 w-full px-8">
                        @csrf
                        @if ($errors->any())
                        ...
                        <div class="flex flex-col space-y-1">
                            ...
                            <input
                                type="text" name="name" id="username" class="rounded-md border border-gray-300 p-2"
                        ...
                        <button type="submit" class="btn btn-primary text-white rounded-lg">Login</button>
                    </form>
                </div>
            </div>
        </main>
