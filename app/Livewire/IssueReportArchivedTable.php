    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Actions')
                ->label(
                    function ($row) {
                        return '<button class="show-btn text-white font-bold p-2 rounded" onclick="document.getElementById(\'my_modal_' . $row->issue_report_id . '\').showModal()">Unarchive</button>
